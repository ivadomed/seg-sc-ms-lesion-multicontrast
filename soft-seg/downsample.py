...
def main():
    ...
    downsample_factors = [(1.3, 1.3, 1.3),(1.5, 1.5, 1.5),(1.7, 1.7, 1.7),(2, 2, 2),(2.3, 2.3, 2.3),(2.5, 2.5, 2.5),(2.7, 2.7, 2.7),(3, 3, 3),
                          (1.3, 1.3, 1),(1.5, 1.5, 1),(1.7, 1.7, 1),(2, 2, 1),(2.3, 2.3, 1),(2.5, 2.5, 1),(2.7, 2.7, 1),(3, 3, 1),
                          (1.3, 1, 1.3),(1.5, 1, 1.5),(1.7, 1, 1.7),(2, 1, 2),(2.3, 1, 2.3),(2.5, 1, 2.5),(2.7, 1, 2.7),(3, 1, 3),
                          (1, 1.3, 1.3),(1, 1.5, 1.5),(1, 1.7, 1.7),(1, 2, 2),(1, 2.3, 2.3),(1, 2.5, 2.5),(1, 2.7, 2.7),(1, 3, 3)
    ]
